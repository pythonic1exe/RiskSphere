...
export function versionFileLabel(version: EvidenceVersion | null, type: EvidenceType) { if (!version) return type === "URL" ? "External URL" : type === "TEXT" ? "Text content" : type === "SYSTEM_RECORD" ? "System record" : "No version added"; return version.fileName ?? (version.externalUrl ? version.externalUrl : type === "TEXT" ? "Text content" : "System record") }
