...
export function DashboardShell({ organizationName, userEmail, title, description, children }: { organizationName: string; userEmail?: string; title?: string; description?: string; children: ReactNode }) {
