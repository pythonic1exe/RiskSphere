...
export function DashboardHeader({ organizationName, userEmail, title = "Dashboard", description }: { organizationName: string; userEmail?: string; title?: string; description?: string }) {
